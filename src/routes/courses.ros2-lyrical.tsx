...
export const Route = createFileRoute("/courses/ros2-lyrical")({
  head: () => ({
    meta: [
      { title: "ROS 2 Lyrical Luth | Code The Robot" },
      ...
      { property: "og:url", content: "https://codetherobot.com/courses/ros2-lyrical" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: "https://codetherobot.com/courses/ros2-lyrical" }],
  }),
