...
const description = "The 30-day refund policy for Code The Robot course purchases.";
export const Route = createFileRoute("/refunds")({
  head: () => ({
    meta: [
      { title: "Refund Policy | Code The Robot" },
      { name: "description", content: description },
      { property: "og:title", content: "Code The Robot Refund Policy" },
  ...
  return (
    <LegalPage title="Refund Policy" updated="18 September 2026">
      <LegalSection title="30-day money-back guarantee">
        <p>
          If you are not satisfied with a paid Code The Robot course, you may request a full refund
